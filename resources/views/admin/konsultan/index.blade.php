...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Tabel Data Konsultan</h3>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <img src="{{ asset('storage/uploads/' . $d->image) }}"
                                                        alt="Gambar Konsultan" width="50" class="img-fluid">
                                                </td>

                                                <td>{{ $d->name }}</td>
                                                <td>
                                                    <li>{{ $d->pengalaman_kerja }}</li>
                                                </td>
                                                <td>{{ $d->karya_ilmiah }}</td>
                                                <td align="center">
                                                ...
                                                @include('admin.component.modal_kn.update')
                                                @include('admin.component.modal_kn.delete')
                                            </tr>
                                        @endforeach
    ...
    @include('admin.component.modal_kn.create')
