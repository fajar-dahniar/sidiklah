...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Tabel Data Instrumen Perencanaan</h3>
                                    ...
                                    <tbody>
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                @include('admin.component.modal_p.update')
                                                @include('admin.component.modal_p.delete')
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
    ...
    @include('admin.component.modal_p.create')
