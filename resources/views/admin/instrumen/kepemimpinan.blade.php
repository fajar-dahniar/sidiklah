...
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Kepemimpinan</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Tabel Data Instrumen Kepemimpinan</h3>
                                    ...
                                    <tbody>
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                @include('admin.component.modal_k.update')
                                                @include('admin.component.modal_k.delete')
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
    ...
    @include('admin.component.modal_k.create')
