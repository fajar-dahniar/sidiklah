<aside class="main-sidebar sidebar-dark-secondary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('admin.dashboard') }}" class="brand-link active bg-success">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('konsultan.index') }}" class="nav-link">
                ...
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('perencanaan-admin.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Perencanaan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('kepemimpinan-admin.index') }}" class="nav-link ">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Kepemimpinan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('supervisi-admin.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Supervisi</p>
                            </a>
                        </li>
