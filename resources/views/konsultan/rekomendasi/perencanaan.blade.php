                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Hasil Diagnosis Perencanaan</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example1" class="table table-stripped table-hover border">
                                    <thead>
                                        <tr align="center">
                                    ...
                                    <tbody>
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                @include('konsultan.component.modal_p')
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
