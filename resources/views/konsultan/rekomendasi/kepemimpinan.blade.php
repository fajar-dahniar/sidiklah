                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Hasil Diagnosis Kepemimpinan</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                @include('konsultan.component.modal_k')
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
